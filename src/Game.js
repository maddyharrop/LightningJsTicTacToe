...
export default class Game extends Lightning.Component {
    ...
    _active() {
        ...
        // We iterate over the outlines of the field and do a nice transition of the width/height so it looks like the lines are being drawn in real time
    ...
    static _states() {
        return [
            class Computer extends this {
                ...
                // Make sure we don't handle any key presses when the computer is player
